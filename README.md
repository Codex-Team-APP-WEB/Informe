...
| ---- | ------ | ----------- | ----------------------- |
| US01 | Búsqueda de artistas por Género y Disponibilidad | Como cliente, quiero poder buscar músicos por género y disponibilidad para encontrar el adecuado para mi evento. | **Escenario 1** Búsqueda Efectiva de Músicos:<br> Dado que un cliente necesita contratar músicos para un evento, cuando utiliza la plataforma para buscar músicos y aplica filtros por género y disponibilidad, entonces recibe una lista precisa de músicos que cumplen con sus criterios de búsqueda.  <br> **Escenario 2** Problemas en la Búsqueda de Músicos: <br> Dado que un cliente necesita contratar músicos para un evento, cuando intenta filtrar músicos por género y disponibilidad en la plataforma, y encuentra que el sistema no proporciona resultados precisos, entonces no podra contactar un musico  |
| US02 | Acceso Completo a Portfolios de Músicos | Como cliente, quiero poder ver el portfolio de cada músico, incluyendo videos y grabaciones de audio, para evaluar su calidad. | **Escenario 1** Acceso Completo a Portafolios de Músicos: <br>Dado que un cliente necesita evaluar músicos para un evento, Cuando navega por los perfiles de los músicos en la plataforma, Entonces puede acceder fácilmente a sus portafolios,  Y puede seleccionar al músico que le guste. <br> **Escenario 2** Problemas de Acceso a Portfolios de Músicos: <br> Dado que un cliente necesita evaluar músicos para un evento, Cuando intenta acceder al portafolio de un músico en la plataforma, Encuentra que no hay suficiente información disponible, Entonces no podrá evaluar la calidad de los músicos. |
...
| US04 | Gestión de Favoritos de Músicos | Como cliente, quiero poder marcar músicos como favoritos en la plataforma para acceder fácilmente a ellos más tarde. | **Escenario 1** Gestión de Favoritos de Músicos efectiva: <br> Dado que un cliente desea guardar músicos para futuras consideraciones, Cuando navega por los perfiles de los músicos en la plataforma, Entonces puede marcar músicos como favoritos,  Y puede revisar  estos músicos mas tarde. <br> **Escenario 2** Problemas en la Gestión de Favoritos de Músicos: <br> Dado que un cliente desea guardar músicos para futuras consideraciones, Cuando intenta marcar músicos como favoritos en la plataforma, Encuentra que la función no está disponible o no funciona , entonces no puede guardar músicos para referencia futura. |
